...
vars = {
  ...
  'ngtcp2_git': 'https://github.com',
  'bnl_git': 'https://github.com',
  ...
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'ngtcp2_revision': '00f8fdc188238b13dc4a9c4a3d96cc1cc1da5386',

  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'bnl_revision': 'f6c6687941e75d292ea3c2915af81af130c42453'
}
...
deps = {
  ...
  'src/third_party/ngtcp2/src':
    Var('ngtcp2_git') + '/DaanDeMeyer/ngtcp2.git' + '@' + Var('ngtcp2_revision'),

  'src/third_party/bnl/src':
    Var('bnl_git') + '/DaanDeMeyer/bnl.git' + '@' + Var('bnl_revision'),
